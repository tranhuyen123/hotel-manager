...
namespace QLKhachSan.GUI
{
    public partial class QuanLyKhachSan : Form
    {
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            Process.Start("file:///C:/Users/Huyen/source/repos/QLKhachSan/QLKhachSan/QLKS/index.html");
        }

        private void hướngDẫnThuêPhòngToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Hướng_dẫn_thuê_phòng a = new Hướng_dẫn_thuê_phòng();
            a.ShowDialog();
        }
        ...
        private void hướngDẫnThanhToánToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Hướng_dẫn_thanh_toán a = new Hướng_dẫn_thanh_toán();
            a.ShowDialog();
        }
        ...
        private void hướngDẫnQuảnLýThiếtBịToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Hướng_dẫn_thiết_bị a = new Hướng_dẫn_thiết_bị();
            a.ShowDialog();
        }
    }
}
